                                                  ...
                                                  G4ForceCondition* condition )
{
  ...
  *condition = NotForced;
  ...
  if((fMaxChargedStep > 0.) &&
     (aTrack.GetVolume() != 0) &&
     (volName=="S2Scintillator"||volName=="S1Scint"||volName=="S1ScintillatorM"||volName=="S1ScintillatorP"||
      volName=="ActiveLayer"||volName=="VetoB"||volName=="VetoLXP"||volName=="VetoLXM"||volName=="VetoLYP"||
      volName=="VetoLYM"||volName=="Sensor"))
