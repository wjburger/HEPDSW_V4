...
TrackerConstructionConfig3::TrackerConstructionConfig3()
  ...
  fPhysiKaptonPLadderL2(0),fPhysiActiveLadderL2(0),fPhysiSiSensorL2(0)
{
  ...
  fKaptonNLadder_Z = 0.1*mm;

  fKaptonPLadder_X = 29*mm;
  fKaptonPLadder_Y = 72*mm;
  fKaptonPLadder_Z = 0.1*mm;
...
void TrackerConstructionConfig3::ComputeObjectsPositioning(){
...
void TrackerConstructionConfig3::Builder(G4VPhysicalVolume* motherVolume)
{
