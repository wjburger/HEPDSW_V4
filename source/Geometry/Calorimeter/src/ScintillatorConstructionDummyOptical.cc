...
#include "ScintillatorConstructionDummyOptical.hh"
...
ScintillatorConstructionDummyOptical::ScintillatorConstructionDummyOptical()
  :
  fSolidS2Scint(0),
  fSolidS1Scint(0),
  fLogicS2Scint(0),
  ...
  fPhysiS1Scint(0)
{
  G4cout << "--------> Creating EJ200 scintillator" << G4endl;
...
void ScintillatorConstructionDummyOptical::ComputeObjectsPositioning(){
...
void ScintillatorConstructionDummyOptical::Builder(G4VPhysicalVolume* motherVolume)
{
