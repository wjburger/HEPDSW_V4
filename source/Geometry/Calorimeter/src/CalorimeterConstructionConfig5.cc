...
CalorimeterConstructionConfig5::CalorimeterConstructionConfig5()
  ...
  fPhysiCFSuppTop(0)
{
  ...
  fCFBlockContainerExt_X = 50.4*mm;
  fCFBlockContainerExt_Y = 50.4*mm;
  fCFBlockContainerExt_Z = 40.0*mm;

  fCFBlockContainerInt_X = 49.4*mm;
  fCFBlockContainerInt_Y = 49.4*mm;
  fCFBlockContainerInt_Z = 40.0*mm;

  fPoronBlockContainerExt_X = 49.4*mm;
  fPoronBlockContainerExt_Y = 49.4*mm;
  fPoronBlockContainerExt_Z = 40.0*mm;

  fPoronBlockContainerInt_X = 47.6*mm;
  fPoronBlockContainerInt_Y = 47.6*mm;
  fPoronBlockContainerInt_Z = 40.0*mm;

  fCrystalBlock_X = 47.6*mm;
  fCrystalBlock_Y = 47.6*mm;
  ...
  fCrystalBlockRawContainer_Y = 50.4*mm;
...
void CalorimeterConstructionConfig5::ComputeObjectsPositioning(){
...
void CalorimeterConstructionConfig5::Builder(G4VPhysicalVolume* motherVolume)
{
