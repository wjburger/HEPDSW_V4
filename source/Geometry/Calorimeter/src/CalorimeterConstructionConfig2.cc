...
CalorimeterConstructionConfig2::CalorimeterConstructionConfig2()
  ...
  fLogicCaloBox(0),fLogicLayer(0),fLogicActiveLayer(0),fLogicCFFront(0),fLogicCFLat(0),fLogicCFSupp(0),fLogicCFSuppTop(0),fLogicPoronLat(0),fLogicPoronLatX(0),	   
  ...
  fPhysiCaloBox(0),fPhysiLayer(0),fPhysiCFSupp(0),fPhysiActiveLayer(0),fPhysiCFFrontP(0),fPhysiCFFrontM(0),fPhysiCFLatP(0),fPhysiCFLatM(0),fPhysiPoronLatP(0),
  fPhysiPoronLatM(0),fPhysiPoronLatXPInt(0),fPhysiPoronLatXMInt(0),fPhysiPoronLatXPExt(0),fPhysiPoronLatXMExt(0),fPhysiPoronLatYPInt(0),fPhysiPoronLatYMInt(0),
...
void CalorimeterConstructionConfig2::ComputeObjectsPositioning(){
...
void CalorimeterConstructionConfig2::Builder(G4VPhysicalVolume* motherVolume)
{
